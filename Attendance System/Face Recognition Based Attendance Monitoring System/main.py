...
def check_haarcascadefile():
    exists = os.path.isfile("C:\\Users\\madha\\Desktop\\Projects\\FaceDetection-HaarCascade-master\\haarcascade_frontalface_default.xml")
    if exists:
        pass
    else:
...
def TakeImages():
    ...
    if ((name.isalpha()) or (' ' in name)):
        ...
        harcascadePath = "C:\\Users\\madha\\Desktop\\Projects\\FaceDetection-HaarCascade-master\\haarcascade_frontalface_default.xml"
